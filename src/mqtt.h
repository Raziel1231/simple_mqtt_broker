...
/*************************************************************
 * Stub bytes, useful for generic replies these represent
...
#define UNSUBACK_BTYE   0x80
#define PINGRESP_BYTE   0x00
...
union mqtt_packet {
    ...
    struct mqtt_unsuscribe unsuscribe;
};
